escalation_prompt = """
        ...
        This analysis aims to flag cases where the customer references any of the following keywords: "Kunal Shah" ,"CEO", "Supervisor", "Senior", "Social Media" ,"Consumer forum" ,"Grievance officer", "threat", "harassment", "RBI", "NPCI" "Police","Court", "Legal action", "Grievance officer", "threat" , "harassment","Suicide", "Advocate" , "Compensation" or any other form of similar threat or harassment. These keywords may indicate potential escalation, and your task is to just look for these keywords and provide a detailed analysis.
